    ...
    , ui(new Ui::Conversor)
{
    ...
    connect(ui->inCent,SIGNAL(valueChanged(int)),this,SLOT(cent2conv(int)));
    connect(ui->inFahr,SIGNAL(valueChanged(int)),this, SLOT (fahr2conv(int)));
    connect(ui->inKel,SIGNAL(valueChanged(int)),this, SLOT (kel2conv(int)));
...
void Conversor::cent2conv(int grados)
{
...
void Conversor::fahr2conv(int grados)
{
...
void Conversor::kel2conv(int grados)
{
